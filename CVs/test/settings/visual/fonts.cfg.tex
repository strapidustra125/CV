...
\newcommand{\funcFontsConfig}
{
    ...
    \renewcommand{\cvfontName}                  {\huge\rmfamily\bfseries}   % Имя кандидата
    \renewcommand{\cvfontTagline}               {\large\bfseries}           % Желаемая должность
    \renewcommand{\cvfontGeneralExperience}     {\small}                    % Суммарный опыт работы
    \renewcommand{\cvfontPersonalinfo}          {\footnotesize}             % Инфо кандидата: телефон, почта и т.д.
    \renewcommand{\cvfontSection}               {\large\rmfamily\bfseries}  % Заголовки секций резюме
    \renewcommand{\cvfontSubsection}            {\large\bfseries}           % Подзаголовки
    \renewcommand{\cvfontPosition}              {\normalsize\bfseries}      % Должность в местах работы
    \renewcommand{\cvfontDatePeriod}            {\small}                    % Блоки с датами работы/учебы

    \renewcommand{\cvdeviderskip}               {\smallskip}                % Отступы вокруг разделителя
