...
\newcommand{\funcExperienceSez}
{
    ...
    Embedded разработка системы дистанционной управления (СДУ) под ARM.
    Разработка консольных приложений под Linux.

    \begin{itemize}

        \item
            Разработал на языке C под STM32 прототип СДУ из 4-х ZigBee устройств для
            кран-балки самолета АН-124.
...
\newcommand{\funcExperiencePrint}
{
    ...
    \funcExperienceSez          % C/C++ developer на СЭЗ
